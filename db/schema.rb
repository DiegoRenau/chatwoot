...
ActiveRecord::Schema[7.1].define(version: 20_260_114_201_315) do
  ...
  create_table 'captain_documents', force: :cascade do |t|
    ...
    t.index %w[assistant_id external_link], name: 'index_captain_documents_on_assistant_id_and_external_link', unique: true
